% ==============================================================================
% intro_stata_basics.tex -- the student deck, in the order of the course's own
% introduction slides, for a small group who have never used Stata.
% Theme "The Prompt" (same as the fuller deck). Draft for the Friday meeting.
% ==============================================================================
...
\begin{frame}{Stata is four windows and one editor}
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img) at (0,0) {\includegraphics[width=11.0cm]{img/stata_window.png}};
...
\begin{frame}[plain]
  ...
  \end{minipage}\\[1.4em]
  {\color{Amber}\large five minutes, because you have a do-file}\\[1.8em]
  {\color{MutedOnInk}\small more exercises and the longer track, from me:}\\[0.3em]
  {\ttfamily\color{SoftBlue}github.com/febriady/intro-to-stata}\\[1.0em]
